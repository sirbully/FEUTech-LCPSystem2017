                ...
                swal({
                    ...
                    if (isConfirm) {
                        swal({
                            ...
                            if(ok) { $(location).attr('href', '<?=base_url()?>doctor/cancelappt/'+event.id) }
                        });
                    }
                });
            },
                ...
                swal({
                    ...
                    if (isConfirm) {
                        swal({
                            ...
                            if(ok) { $(location).attr('href', '<?=base_url()?>doctor/resched/'+event.id+'/'+event.start.format()+'/'+event.end.format()); }
                        });
                    } else { revertFunc(); }
                });
            },
