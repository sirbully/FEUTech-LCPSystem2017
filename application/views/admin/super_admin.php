...
<html lang="en">
    ...
    <div class="row">
        ...
        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
            ...
            <tbody>
                <td><?= $rec->user_id ?></td>
                <td><?= $rec->user_uname ?></td>
                <td><?= $rec->user_pass ?></td>
                <td><?= $rec->user_fname ?></td>
                <td><?= $rec->user_lname ?></td>
                <form method="post" action="<?= base_url()?>admin/updateaccount_submit" >
                    <input type="hidden" value="<?= $rec->user_id?>" name="user_id" >
                    <td><input type="number" value="<?= $rec->user_type?>" name="acc_lvl" ></td>
