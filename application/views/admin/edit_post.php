    ...
    <body>
        <nav class="blue darken-2" role="navigation">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                  ...
                  <li><a class="white-text" href="<?= base_url()?>moderator/logout">Logout</a></li>
                </ul>
        ...
        <div class="container ">
            <div class="z-depth-1 grey lighten-4 row" style="padding: 32px 90px 50px 90px; border: 1px solid #EEE;"> 
                <form class="col s12" method="post" action="<?=base_url()?>moderator/edit_post_submit" enctype="multipart/form-data">
                    <div class="input-field col s12">
                        <select class="browser-default" name="category" value="<?=$data->category?>">
                    ...
                    <div class="file-field input-field col s12 ">
                        <div class="file-path-wrapper">
                            ...
                            <input type="file" name="pic" value="<?=$data->image?>">
                            <input class="file-path" type="text" placeholder="Upload image" >  
                        </div>
                    </div>
                    <div class="input-field col s12">
                        <textarea id="textarea1" class="materialize-textarea" name="message" value="<?=$data->context?>"></textarea> 
